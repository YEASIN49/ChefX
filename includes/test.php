   ...
   <div>
    <form method="post">
     <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
      <img src="images/menu-2.jpg?>" class="img-responsive" /><br />

      <h4 class="text-info"><?php echo $row["menuName"]; ?></h4>

      <h4 class="text-danger">$ <?php echo $row["menuPrice"]; ?></h4>
      ...
      <input type="hidden" name="hidden_id" value="<?php echo $row["mealID"]; ?>" />
